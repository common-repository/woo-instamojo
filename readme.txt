...
Tags: commerce, e-commerce, payment-gateway, payments, easy payments, payments button
...
* Updated supported WordPress version to 6.5.2
* Updated supported WooCommerce version to 8.8.3
